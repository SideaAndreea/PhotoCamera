...
var PostmanFetch = function PostmanFetch(json) {
  ...
  this.fetch = function (key) {
    ...
    var data = _ref.data,
        ...
        restConfig = _objectWithoutProperties(_ref, ["data", "params", "headers"]);
    ...
    if (foundRequest) {
      ...
      var _headers = _objectSpread({}, _this.generateObjects(foundRequest.header, 'headers'), _this.headers, _headers);
